...
type Transferable = OffscreenCanvas | ImageBitmap | MessagePort | ReadableStream | WritableStream | TransformStream | WebTransportSendStream | WebTransportReceiveStream | ArrayBuffer;
